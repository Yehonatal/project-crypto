...
const CryptoHighlightsPage = () => {
  ...
  useEffect(() => {
    const fetchHighlightsData = async () => {
      try {
        ...
        const gainers = marketResult.filter((coin: CoinData) => coin.price_change_percentage_24h > 0).slice(0, 8);
        const losers = marketResult.filter((coin: CoinData) => coin.price_change_percentage_24h < 0).slice(-8).reverse();
  ...
  const tabs = [
    ...
    { id: 'airdrop', label: 'Airdropped Tokens by NFT Projects', icon: '🪂' },
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Crypto Highlights</h1>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-lg font-semibold text-gray-900">Trending Coins</h2>
            </div>
          ...
          <div className="space-y-1">
            ...
            {trendingData?.coins.slice(0, 8).map((trending) => (
              <div key={trending.item.id} className="grid grid-cols-4 gap-4 items-center py-2 hover:bg-gray-50 rounded">
                <div className="flex items-center gap-2">
                  <img 
                  ...
                  />
                  <span className="font-medium text-gray-900 text-sm truncate">{trending.item.name}</span>
                </div>
                <div className="text-right text-sm font-medium">$4,194.57</div>
                <div className="text-right">
                  <span className="text-green-600 font-semibold text-sm">▲ 7.6%</span>
                </div>
                <div></div>
              </div>
            ))}
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="space-y-1">
            ...
            {topGainers.slice(0, 8).map((gainer) => (
              <div key={gainer.id} className="grid grid-cols-4 gap-4 items-center py-2 hover:bg-gray-50 rounded">
                <div className="flex items-center gap-2">
                  <img 
                    src={gainer.image} 
                    alt={gainer.name}
                    className="w-5 h-5 rounded-full"
                  />
                  <span className="font-medium text-gray-900 text-sm truncate">{gainer.symbol.toUpperCase()}</span>
                </div>
                <div className="text-right text-sm font-medium">{formatPrice(gainer.current_price)}</div>
                <div className="text-right">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="space-y-1">
            ...
            {topLosers.slice(0, 8).map((loser) => (
              <div key={loser.id} className="grid grid-cols-4 gap-4 items-center py-2 hover:bg-gray-50 rounded">
                <div className="flex items-center gap-2">
                  <img 
                    src={loser.image} 
                    alt={loser.name}
                    className="w-5 h-5 rounded-full"
                  />
                  <span className="font-medium text-gray-900 text-sm truncate">{loser.symbol.toUpperCase()}</span>
                </div>
                <div className="text-right text-sm font-medium">{formatPrice(loser.current_price)}</div>
                <div className="text-right">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-8">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-lg font-semibold text-gray-900">New Coins</h2>
            </div>
            <a href="#" className="text-blue-600 hover:text-blue-700 text-sm font-medium">
              more →
            </a>
          ...
          <div className="space-y-1">
            ...
            {newCoins.slice(0, 8).map((coin) => (
              <div key={coin.id} className="grid grid-cols-4 gap-4 items-center py-2 hover:bg-gray-50 rounded">
                <div className="flex items-center gap-2">
                  <img 
                    src={coin.image} 
                    alt={coin.name}
                    className="w-5 h-5 rounded-full"
                  />
                  <span className="font-medium text-gray-900 text-sm truncate">{coin.symbol.toUpperCase()}</span>
                </div>
                <div className="text-right text-sm font-medium">{formatPrice(coin.current_price)}</div>
                <div className="text-right">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              <span className="text-orange-500 text-xl">🔓</span>
              <h2 className="text-lg font-semibold text-gray-900">Incoming Token Unlocks</h2>
            </div>
            <a href="#" className="text-blue-600 hover:text-blue-700 text-sm font-medium">
              more →
            </a>
          ...
          <div className="space-y-1">
            ...
            <div className="grid grid-cols-4 gap-4 items-center py-2 hover:bg-gray-50 rounded">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-gray-900 text-sm">Movement</span>
              </div>
              <div className="text-right text-sm">0d 02h 10m 41s</div>
              <div></div>
              <div></div>
            </div>
            ...
            <div className="grid grid-cols-4 gap-4 items-center py-2 hover:bg-gray-50 rounded">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-gray-900 text-sm">Render</span>
              </div>
              <div className="text-right text-sm">0d 14h 10m 41s</div>
              <div></div>
              <div></div>
            </div>
          </div>
